...
from .views import (
    CartAPIView, CartItemAPIView, CartItemDetailAPIView, CheckoutAPIView, CartMergeAPIView,
...
urlpatterns = [
    ...
    path('checkout/', ratelimit(key='ip', rate='10/m', block=True)(CheckoutAPIView.as_view()), name='checkout'),
